...
from report_potholes.views import PotholeCreateViewPublic, ApprovedPotholeMapView, PotholeDetailView, PotholeThanksView
...
urlpatterns = [
    ...
    path('report/', PotholeCreateViewPublic.as_view(), name='report'),
